package com.sheaf.sparking.widget;
...
public class EditText_Clear extends android.support.v7.widget.AppCompatEditText {
     ...
     */
    private void init() {
        clearDrawable = getResources().getDrawable(scut.carson_ho.searchview.R.drawable.clear);
        searchDrawable = getResources().getDrawable(scut.carson_ho.searchview.R.drawable.search);
